...
python3 train_bigset.py --image_set p --model_name alexnet --device iphone --environment all  --clip_target True --normalize_target True
...
# python3 train_bigset.py --image_set k --model_name alexnet --device iphone --environment all  --clip_target True --normalize_target True
